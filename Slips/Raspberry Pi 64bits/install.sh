...
ZEEK_REPO_URL="download.opensuse.org/repositories/security:/zeek/Debian_${DEBIAN_VERSION}"
...
&& pip3 install --ignore-installed -r install/requirements.txt --break-system-packages \
&& pip3 install --ignore-installed six --break-system-packages
